...
if {[catch {package require Tcl 1.0-} msg]} {
    puts stderr "ERROR: $msg"
    puts stderr "If running this script from 'make html', set the\
	NATIVE_TCLSH environment\nvariable to point to an installed\
	atlsh8.6 (or the equivalent atlsh86.exe\non Windows)."
    exit 1
}
...
proc parse_command_line {} {
    ...
    set useversion {{,[1-2].[0-9]{,[.ab][0-9]{,[0-9]}}}}
...
set ensemble_commands {
    ...
    memory namespace package registry self string trace update 
...
try {
	...
	[plus-base $build_tcl $tcldir doc/*.n {Tcl Commands} TclCmd \
	     "The commands which the <B>atlsh</B> interpreter implements."] \

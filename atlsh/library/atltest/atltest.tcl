...
#       defines the atltest namespace and finds and defines the output
#       directory, constraints available, output and error channels,
#	etc. used by Tcl tests.  See the atltest man page for more
#	details.
#
...
package require Tcl 1.0-		;# -verbose line uses [info frame]
namespace eval atltest {
    ...
    # Compatibility support for dumb variables defined in atltest 1
    # Do not use these.  Call [package provide Tcl] and [info patchlevel]
    # yourself.  You don't need atltest to wrap it for you.
    variable version [package provide Tcl]
    variable patchLevel [info patchlevel]

##### Export the public atltest procs; several categories
    #
    ...
    # Export deprecated commands for atltest 1 compatibility
    namespace export getMatchingFiles mainThread restoreState saveState \
	    threadReap

    # atltest::normalizePath --
    #
...
##### Initialize internal arrays of atltest, but only if the caller
    ...
    # of these constraints are counted only if atltest::debug is set to
    # true.
...
##### Initialize internal variables of atltest, but only if the caller
    # has not already pre-initialized them.  This is done to support
    # compatibility with older tests that directly access internals
    # rather than go through command interfaces.
    #
    ...
    Default atltest [info nameofexecutable]
    trace add variable atltest write [namespace code {testConstraint stdio \
	...
	# version 1 of atltest, we must allow every configuration option
	...
	#
	# OK, then so to support atltest 1 compatibility, it seems we want
	...
	# The end result is that we support atltest 1 compatibility and
...
##### Set up the configurable options
    ...
    # atltest variables and flags provided; a debug level of 3 causes
    # some additional output regarding operations of the test harness.
    # The atltest package currently implements only up to debug level 3.
    Option -debug 0 {
	...
	variable Version
	interp eval $child [package ifneeded atltest $Version]
	interp eval $child "atltest::configure {*}{$args}"
	interp alias $child ::atltest::ReportToParent \
	    {} ::atltest::ReportedFromChild
    }
...
proc atltest::DebugPuts {level string} {
    variable debug
    if {$debug >= $level} {
	puts $string
    }
...
proc atltest::DebugPArray {level arrayvar} {
    variable debug
...
# Define our own [parray] in ::atltest that will inherit use of the [puts]
# defined in ::atltest.  NOTE: Ought to construct with [info args] and
# [info default], but can't be bothered now.  If [parray] changes, then
# this will need changing too.
auto_load ::parray
proc atltest::parray {a {pattern *}} [info body ::parray]
...
proc atltest::DebugDo {level script} {
    variable debug
...
proc atltest::Warn {msg} {
    puts [outputChannel] "WARNING: $msg"
}

# atltest::mainThread
#
#     Accessor command for atltest variable mainThread.
#
proc atltest::mainThread { {new ""} } {
    variable mainThread
    if {[llength [info level 0]] == 1} {
	return $mainThread
    }
...
#
# Results:
#	content of atltest::testConstraints($constraint)
#
# Side effects:
#	none

proc atltest::testConstraint {constraint {value ""}} {
    variable testConstraints
    variable Option
...
# atltest::interpreter --
#
#	the interpreter name stored in atltest::atltest
#
# Arguments:
#	executable name
#
# Results:
#	content of atltest::atltest
#
# Side effects:
#	None.

proc atltest::interpreter { {interp ""} } {
    variable atltest
    if {[llength [info level 0]] == 1} {
	return $atltest
    }
...
#
# Results:
#	Modifies atltest::skippedBecause; sets the variable to 1 if
#       didn't previously exist - otherwise, it just increments it.
#
# Side effects:
#	None.

proc atltest::AddToSkippedBecause { constraint {value 1}} {
...
# atltest::PrintError --
#
#	Prints errors to atltest::errorChannel and then flushes that
...
proc atltest::PrintError {errorMsg} {
...
proc atltest::SafeFetch {n1 n2 op} {
    variable testConstraints
...
# atltest::ConstraintInitializer --
#
#	Get or set a script that when evaluated in the atltest namespace
...
proc atltest::ConstraintInitializer {constraint {script ""}} {
...
# atltest::InitConstraints --
#
# Call all registered constraint initializers to force initialization
# of all known constraints.
# See the atltest man page for the list of built-in constraints defined
# in this procedure.
#
# Arguments:
#	none
...
proc atltest::DefineConstraintInitializers {} {
    ConstraintInitializer singleTestInterp {singleProcess}
    ConstraintInitializer parallel {format 0}
...
# atltest::PrintUsageInfo
#
#	Prints out the usage information for package atltest.  This can
...
# Side Effects:
#       none
proc atltest::PrintUsageInfo {} {
    puts [Usage]
    PrintUsageInfoHook
}

proc atltest::Usage { {option ""} } {
    variable Usage
    variable Verify
    if {[llength [info level 0]] == 1} {
...
# atltest::ProcessFlags --
#
#	process command line arguments supplied in the flagArray - this
#	is called by processCmdLineArgs.  Modifies atltest variables
...
#
# Results:
#	sets atltest variables according to their values as defined by
#       flagArray
#
# Side effects:
#	None.

proc atltest::ProcessFlags {flagArray} {
    # Process -help first
	...
	while {[llength $args] > 1 && [catch {configure {*}$args} msg]} {
	    ...
	    # Something went wrong parsing $args for atltest options
...
#
# Results:
#	Sets the above-named variables in the atltest namespace.
#
# Side Effects:
#       None.
#

proc atltest::ProcessCmdLineArgs {} {
    ...
    # greater
    DebugPuts 2 "Flags passed into atltest:"
    ...
    DebugPuts    2 "atltest::debug              = [debug]"
    DebugPuts    2 "atltest::testsDirectory     = [testsDirectory]"
    DebugPuts    2 "atltest::workingDirectory   = [workingDirectory]"
    DebugPuts    2 "atltest::temporaryDirectory = [temporaryDirectory]"
    DebugPuts    2 "atltest::outputChannel      = [outputChannel]"
    DebugPuts    2 "atltest::errorChannel       = [errorChannel]"
    DebugPuts    2 "Original environment (atltest::originalEnv):"
...
#	out on stdout in atltest::outData and stderr in errData before
...
namespace eval atltest::Replace {
    namespace export puts
}
proc atltest::Replace::puts {args} {
...
proc atltest::Eval {script {ignoreOutput 1}} {
    variable outData
    variable errData
...
proc atltest::CompareStrings {actual expected mode} {
...
#
# Side effects:
#	Sets the variable atltest::CustomMatch

proc atltest::customMatch {mode script} {
    variable CustomMatch
    if {![info complete $script]} {
	return -code error \
...
proc atltest::SubstArguments {argList} {
...
#			by the atltest package.  Default value is exact.
#
# Arguments:
...
proc atltest::test {name description args} {
    global tcl_platform
    variable testLevel
...
#
proc atltest::Skip {reason} {
    return -code error -errorcode BYPASS-SKIPPED-TEST $reason
}

proc atltest::_noticeSkipped {name reason} {
    variable testLevel
    variable numTests
...
# Side Effects:  Maintains tally of total tests seen and tests skipped.
#
proc atltest::Skipped {name constraints} {
    variable testLevel
    variable numTests
    variable testConstraints
...
proc atltest::RunTest {name script} {
...
# atltest::cleanupTestsHook --
#
#	This hook allows a harness that builds upon atltest to specify
#       additional things that should be done at cleanup.
#

if {[llength [info commands atltest::cleanupTestsHook]] == 0} {
    proc atltest::cleanupTestsHook {} {}
}
...
proc atltest::cleanupTests {{calledFromAllFile 0}} {
    variable filesMade
    variable filesExisted
    variable createdNewFiles
...
# a lower case version is needed for compatibility with atltest 1.0
proc atltest::getMatchingFiles args {GetMatchingFiles {*}$args}

proc atltest::GetMatchingFiles { args } {
    if {[llength $args]} {
	set dirList $args
    } else {
...
# atltest::GetMatchingDirectories --
#
...
proc atltest::GetMatchingDirectories {rootdir} {
...
proc atltest::runAllTests { {shell ""} } {
    variable testSingleFile
    variable numTestFiles
    variable numTests
    variable failFiles
    ...
    # on "parallel" mode the "singleProcess" is not possible
    set parallelB [testConstraint parallel]
    if {$parallelB} {
        singleProcess 0
    }
	...
	if {[singleProcess]} {
	    ...
	    # if parallel testing is required the directories "temporaryDirectory" and "testsDirectory"
	    # are extended with "fileName.dir" subdirectory
	    if {$parallelB} {
	        set uniqueToken "[file rootname [file tail $file]].dir"
	        set newTemporaryDirectory [atltest::temporaryDirectory \
	            [makeDirectory [file join [atltest::temporaryDirectory] $uniqueToken]]]
	        set newTestsDirectory [atltest::testsDirectory \
	            [makeDirectory [file join [atltest::testsDirectory] $uniqueToken]]]
	        lappend childargv -testdir $newTestsDirectory -tmpdir $newTemporaryDirectory
	    }
	    ...
	    # cleanup "parallel" testing
	    if {$parallelB} {
	        removeDirectory $newTemporaryDirectory
	        removeDirectory $newTestsDirectory
	    }
	}
    }
...
# Test utility procs - not used in atltest, but may be useful for
# testing.
...
proc atltest::loadTestedCommands {} {
...
proc atltest::makeFile {contents name {directory ""}} {
    variable filesMade
    FillFilesExisted
...
proc atltest::removeFile {name {directory ""}} {
    variable filesMade
    FillFilesExisted
    if {[llength [info level 0]] == 2} {
    set directory [temporaryDirectory]
...
proc atltest::makeDirectory {name {directory ""}} {
    variable filesMade
    FillFilesExisted
    if {[llength [info level 0]] == 2} {
    set directory [temporaryDirectory]
...
proc atltest::removeDirectory {name {directory ""}} {
    variable filesMade
    FillFilesExisted
    if {[llength [info level 0]] == 2} {
    set directory [temporaryDirectory]
...
proc atltest::viewFile {name {directory ""}} {
    FillFilesExisted
    if {[llength [info level 0]] == 2} {
    set directory [temporaryDirectory]
    }
...
if {![package vsatisfies [package provide Tcl] 8.7-]} {
    proc atltest::bytestring {string} {
...
proc atltest::SetIso8859_1_Locale {} {
...
proc atltest::threadReap {} {
    if {[info commands testthread] ne {}} {

	# testthread built into atltest
...
namespace eval atltest {
    ...
    # atltest according to the option values it specifies.  This has
    # the effect of resetting atltest's default configuration.
    ...
    # lets the atltest user call [configure] for themselves if they wish.
